        ...
        if not need_check:
            try:
                ...
                for value in brands_values:
                    vendor = str(value.get("name")).upper()
            ...
            if not special_product_db.contains(query.id == initial_product_id):
                ...
                url_db.remove(query.product_url == product_url)
                print(f"Special Product added : {product_url}")
            else:
                url_db.remove(query.product_url == product_url)
                print(f"This special product already exists : {product_url}")
        else:
            pass
...
if __name__ == '__main__':
    ...
    url_db = TinyDB("./db_files/harrods_product_url.json")
